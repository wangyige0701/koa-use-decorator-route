export const ROUTES = Symbol.for('koa-decorator-route#routes');
export const CONTROLLER = Symbol.for('koa-decorator-route#controller');
export const SINGLETON = Symbol.for('koa-decorator-route#singleton');
export const INJECT = Symbol.for('koa-decorator-route#inject');
export const INJECT_METHOD = Symbol.for('koa-decorator-route#inject-method');
